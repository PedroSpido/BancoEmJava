...
public class TesteOrdenacaoLambdas {
	...
	public static void main(String[] args) {
		...
		//Metoro que itera a lista de contas -> Lambda com no metodo foreach que recebe um Consumer como parametro:
		lista.forEach( (conta) -> System.out.println("Conta: "+ conta+ " , "+conta.getTitular().getNome()));				
